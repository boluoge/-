...
<header class="header left">
    ...
    <div class="right nav text_right">
        <ul> <li><i class="nav_7"></i><a href="/car/jsp/static">查询统计</a> </li>
            <li class="nav_active"><i class="nav_8"></i><a href="/car/jsp/message">信息录入</a> </li>
...
<script src="/resources/js/utf8-php/ueditor.config.js"></script>
<script src="/resources/js/utf8-php/ueditor.all.min.js"></script>
